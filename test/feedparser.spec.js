...
describe('[angular-feedparser] ', function () {
  ...
  describe('rdf 1.0 > ', function() {
    ...
    it('entries basic info', function() {
      ...
      expect(entries[0].url).toBe('http://daurmith.blogalia.com//historias/75874');
  ...
  describe('rss 2.0 > ', function() {
    ...
    it('entries basic info', function() {
      ...
      expect(entries[0].url).toBe('https://daurmith.wordpress.com/2012/04/18/so-you-want-to-order-coffee-in-spain/');
  ...
  describe('atom 1.0 > ', function() {
    ...
    it('entries basic info', function() {
      ...
      expect(entries[0].url).toBe('http://www.alexandrafranzen.com/2015/09/29/respect/');
